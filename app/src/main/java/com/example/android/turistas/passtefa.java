...
public class passtefa extends FragmentActivity implements OnPageChangeListener {
    ...
    public static final String RESPUBLIKOS_G_49_TELŠIAI_87130 = "Respublikos g. 49, Telšiai 87130";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adress.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                skamb();
                String str_location = RESPUBLIKOS_G_49_TELŠIAI_87130;
        ...
        googlesearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                skamb();
                String daugiau = HTTPS_WWW_GOOGLE_COM_SEARCH_CLIENT_FIREFOX_B_BIW_1920_BIH_971_EI_LQL9_WBU_LBCM_UA_JNTH_MAD_Q_PAS_STEF_C4_85_TEL_C5_A1IAI_OQ_PAS_STEF_C4_85_TEL_C5_A1IAI_GS_L_PSY_AB_12_0_0_0_829_0_0_0_0_0_0_0_0_0_0_0_1_64_PSY_AB_0_0_0_0_RZ70GE6_H9_U8_GFE_RD_CR_DCR_0;
                Intent i = new Intent(Intent.ACTION_VIEW, Uri.parse(daugiau));
                startActivity(i);
            }
        });
        viewPage = (ViewPager) findViewById(R.id.viewPager);
        imageId = new Images(PASSTEFA);
        ...
        viewPage.setOnPageChangeListener(passtefa.this);
